...
WALA_MINRANGE_CM = 20  # minimal range threshold in cm (1...1000)
WALA_MAXRANGE_CM = 500  # maximal range threshold in cm (1...1000)
WALA_RANGESTEPSIZE_CM = 4.0  # Resolution in cm (0.1...10)
WALA_HORIZONTALANGLE = 20  # ?...90 Degrees (90 means 180)
WALA_HORIZONTALSTEPSIZE_DEG = 5  # Resolution in degrees (1.0...10)
WALA_VERTICALANGLE_DEG = 10  # ?...90 Degrees (90 means 180)
WALA_VERTICALSTEPSIZE_DEG = 5  # Resolution in degrees (1.0...10) (smaller means finer)
...
CLUSTERING_THRESHOLD = 120 # from which intensity on a point becomes a hotspot?
CLUSTER_HISTORY_STACK_SIZE = 100  # how many frames to look into the past for clusters?
CLUSTER_SPATIAL_THRESHOLD = 2  # recommended: 1 - 3
MINCLUSTERSIZE = 4  # how many hotspots make a cluster?
RANGE_FILTER_THRESHOLD = 6
BOXOFFSET = 0.05
